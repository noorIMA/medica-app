...
class SignInAScreen extends StatefulWidget {
  const SignInAScreen({super.key});

  @override
  State<SignInAScreen> createState() => _SignInAScreenState();
}

class _SignInAScreenState extends State<SignInAScreen> {
 final TextEditingController phoneController = TextEditingController();
  ...
  void sendPhoneNum() {
    ...
    ap.signInAWithPhoneNum(context, "+${selectedCountry.phoneCode}$phoneNum");
    }
  }
}