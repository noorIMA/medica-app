...
import 'package:medica_app/Screens/UserInfo_Screen.dart';
...
class OtpScreen2 extends StatefulWidget {
  ...
  const OtpScreen2({super.key, required this.verificationId});
    ...
    ap.verifyOtpCode(
        ...
        onSuccess: () {
          ...
          ap.checkExistingUser().then((value) async {
            if (value == true) {
              //user exists
              showSnackBar(context, "${AppLocalizations.of(context)?.translate('userexist')}");
            } else {
              //new user
