...
class SignInDScreen extends StatefulWidget {
  const SignInDScreen({super.key});

  @override
  State<SignInDScreen> createState() => _SignInDScreenState();
}

class _SignInDScreenState extends State<SignInDScreen> {
  ...
  void sendPhoneNum() {
    ...
    String phoneNum = phoneController.text.trim();
      ...
      showSnackBar(
          ...
          ap.signInDWithPhoneNum(context, "+${selectedCountry.phoneCode}$phoneNum");
