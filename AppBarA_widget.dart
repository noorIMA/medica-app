...
class AppBarAWidget extends StatefulWidget {
  const AppBarAWidget({super.key});

  @override
  State<AppBarAWidget> createState() => _AppBarAWidgetState();
}

class _AppBarAWidgetState extends State<AppBarAWidget> {
  @override
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              "${AppLocalizations.of(context)?.translate('hello')}, ${ap.adminModel.name}",
              style: TextStyle(
                fontSize: 20,
